...
const VoiceAssistant: React.FC<VoiceAssistantProps> = ({ onCommand, onToggle }) => {
  ...
  return (
    <div className="fixed bottom-6 left-6 bg-slate-800/90 backdrop-blur-sm shadow-lg rounded-xl p-4 flex flex-col items-center z-50 border border-blue-500/20">
      <button
