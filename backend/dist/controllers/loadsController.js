...
exports.addLoad = exports.cancelLoad = exports.bookLoad = exports.getAvailableLoads = void 0;
...
exports.getAvailableLoads = getAvailableLoads;
const bookLoad = async (req, res) => {
    try {
        ...
        if (load.status !== 'available')
            return res.status(409).json({ error: 'Load not available' });
