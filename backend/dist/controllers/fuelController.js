...
exports.findNearestFuelStation = exports.getFuelStatus = void 0;
...
const findNearestFuelStation = async (req, res) => {
    try {
        ...
        const fuelStations = [
            {
                ...
                distance_km: Math.random() * parseFloat(radius_km),
                fuel_types: ['Petrol', 'Diesel', 'CNG'],
                amenities: ['ATM', 'Restroom', 'Food Court'],
                operating_hours: '24/7',
                latitude: parseFloat(latitude) + (Math.random() - 0.5) * 0.1,
                longitude: parseFloat(longitude) + (Math.random() - 0.5) * 0.1,
                price_per_liter: {
...
exports.findNearestFuelStation = findNearestFuelStation;
